...
namespace WorkflowCore.Models
{
    public class WorkflowOptions
    {
        ...
        /// </summary>
        /// <param name="value">If you want the workflow to execute all the steps on the same node until the event waits, set true. Otherwise false.</param>
        public void UseSingleTaskToUntilWaitEvent(bool value)
        {
            UseSingleTask = value;
        }
    }
